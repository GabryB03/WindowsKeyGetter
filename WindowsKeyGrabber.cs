...
public static class WindowsKeyGrabber
{
    public static string GetWindowsProductKeyFromRegistry()
    {
        try
        {
            ...
            return GetWindowsProductKeyFromDigitalProductId(digitalProductId, Environment.OSVersion.Version.Major == 6 && Environment.OSVersion.Version.Minor >= 2 || Environment.OSVersion.Version.Major > 6 ? DigitalProductIdVersion.Windows8AndUp : DigitalProductIdVersion.UpToWindows7);
        }
        catch
        {
            return "";
